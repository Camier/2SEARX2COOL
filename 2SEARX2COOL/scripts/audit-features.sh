...
# Audit results file
AUDIT_REPORT="/home/mik/SEARXNG/2SEARX2COOL/AUDIT-REPORT-20250616-011635.md"
...
**System**: mik-wsl
**User**: mik
**Project Path**: /home/mik/SEARXNG/2SEARX2COOL
...
EOF && chmod +x /home/mik/SEARXNG/2SEARX2COOL/scripts/audit-features.sh && echo "Audit script created and made executable"
