...
def fix_base_music_py():
    ...
    file_path = '/home/mik/SEARXNG/2SEARX2COOL/searxng-core/searxng-core/searx/engines/base_music.py'
...
def update_settings_yml():
    ...
    settings_path = '/home/mik/SEARXNG/2SEARX2COOL/searxng-core/searxng-core/searx/settings.yml'
