...
from models.music.track import Track, TrackSource
from models.music.artist import Artist
from models.music.album import Album
from services.content_classifier import classifier
...
class MusicSearchService:
    ...
    def search(self, query: str, engines: Optional[List[str]] = None, 
        ...
        cached_result = cache.get(query, engines)
        if cached_result:
        ...
        cache.set(query, result, engines, ttl=1800)  # Cache for 30 minutes
    ...
    def _search_engine(self, query: str, engine: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            headers = {
                'User-Agent': '2SEARX2COOL Orchestrator/1.0',
